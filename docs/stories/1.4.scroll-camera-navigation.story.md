...
- [ ] Create CameraController component (AC: 1)
  - [ ] Create file `src/components/3d/CameraController.tsx`
  - [ ] Set up component structure with camera ref
  - [ ] Export CameraController component with named export
  - [ ] Follow 3D component standards

- [ ] Implement scroll event capture (AC: 2, 8)
  - [ ] Add wheel event listener or use drei's ScrollControls
  - [ ] Capture scroll delta (wheel deltaY)
  - [ ] Store scroll state (current scroll position)
  - [ ] Test mouse wheel on desktop browsers

- [ ] Implement camera Z position control (AC: 3, 6)
  - [ ] Calculate target Z position from scroll delta
  - [ ] Scrolling down decreases Z (moves forward)
  - [ ] Scrolling up increases Z (moves backward)
  - [ ] Keep Y position at 0 (maintains focus on cards)
  - [ ] Keep X position at 0 (maintains center alignment)

- [ ] Add smooth interpolation (lerp) (AC: 4, 7)
  - [ ] Use useFrame to update camera position every frame
  - [ ] Implement lerp function: `current + (target - current) * lerpFactor`
  - [ ] Set lerpFactor to 0.05-0.1 for smooth movement
  - [ ] Ensure 16ms frame time (60 FPS) is maintained

- [ ] Implement scroll bounds (AC: 5)
  - [ ] Set minimum Z position (closest to cards, e.g., 2)
  - [ ] Set maximum Z position (farthest from cards, e.g., 8)
  - [ ] Clamp target Z position within bounds
  - [ ] Test bounds by scrolling extensively in both directions

- [ ] Integrate CameraController into Scene (AC: 9, 10)
  - [ ] Add CameraController to Scene.tsx
  - [ ] Ensure camera updates don't conflict with Canvas camera prop
  - [ ] Test scroll behavior in Chrome, Firefox, Safari
  - [ ] Monitor performance with DevTools (no jank or dropped frames)

- [ ] Test and verify scroll navigation (AC: 7, 8, 9, 10)
  - [ ] Test natural and responsive feel
  - [ ] Verify mouse wheel works correctly
  - [ ] Test in Chrome, Firefox, Safari
  - [ ] Check for scroll jank or dropped frames
